...
echo "<h3>Caso 1 - Cadastro válido (João da Silva)</h3>";
$message = $userManager->register('João da Silva', 'joao@email.com', 'SenhaForte1');
...
// Caso 4 - Reset de senha válido (Poliana)
